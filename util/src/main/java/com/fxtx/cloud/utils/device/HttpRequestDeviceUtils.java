package com.fxtx.cloud.utils.device;

import cn.jpush.api.utils.StringUtils;
import com.fxtx.cloud.utils.ServletUtils;
...
public class HttpRequestDeviceUtils {
     ...
     * @return
     */
    public static String getUserAgentLimit200(){
        HttpServletRequest request = ServletUtils.getServletRequest();
        if(request !=null){
            String userAgent = request.getHeader("User-Agent");
            if(StringUtils.isNotEmpty(userAgent) && userAgent.length()>200){
